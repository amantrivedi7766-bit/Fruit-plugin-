private void registerFruits() {
    ...
    // 2. Moon Crescent (formerly Banana)
    ...
    // 6. Thorned Crown (formerly Pineapple)
    ...
    // 7. Ruby Heart (formerly Strawberry)
    ...
    // 8. Jade Melon (formerly Watermelon)
    ...
    // 9. Drake's Tear (formerly Dragon Fruit)
